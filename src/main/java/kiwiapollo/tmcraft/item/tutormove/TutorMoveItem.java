...
public class TutorMoveItem {
  ...
  public static final Item TUTOR_10000000VOLTTHUNDERBOLT = register("10000000voltthunderbolt",
  ...
  public static final Item TUTOR_CLANGOROUSSOULBLAZE = register("clangoroussoulblaze",
  ...
  public static final Item TUTOR_LETSSNUGGLEFOREVER = register("letssnuggleforever",
  ...
  public static final Item TUTOR_LIGHTTHATBURNSTHESKY = register("lightthatburnsthesky",
  ...
  public static final Item TUTOR_MENACINGMOONRAZEMAELSTROM = register("menacingmoonrazemaelstrom",
  ...
  public static final Item TUTOR_NEVERENDINGNIGHTMARE = register("neverendingnightmare",
      ElementalTypes.INSTANCE.getGHOST());
  ...
  public static final Item TUTOR_PULVERIZINGPANCAKE = register("pulverizingpancake",
  ...
  public static final Item TUTOR_SEARINGSUNRAZESMASH = register("searingsunrazesmash",
  ...
  public static final Item TUTOR_SOULSTEALING7STARSTRIKE = register("soulstealing7starstrike",
      ElementalTypes.INSTANCE.getGHOST());
  ...
  public static final Item TUTOR_SPLINTEREDSTORMSHARDS = register("splinteredstormshards",
  ...
  public static final Item TUTOR_STOKEDSPARKSURFER = register("stokedsparksurfer",
      ElementalTypes.INSTANCE.getELECTRIC());
  ...
  public static final Item TUTOR_SUPERSONICSKYSTRIKE = register("supersonicskystrike",
  ...
  public static final Item TUTOR_BENEDICTION = register("benediction", ElementalTypes.INSTANCE.getFAIRY());
  public static final Item TUTOR_BLADESFLURRY = register("bladesflurry", ElementalTypes.INSTANCE.getSTEEL());
  public static final Item TUTOR_CLEANCUT = register("cleancut", ElementalTypes.INSTANCE.getSTEEL());
  public static final Item TUTOR_CRAGGYSHOULDERBASH = register("craggyshoulderbash", ElementalTypes.INSTANCE.getROCK());
  public static final Item TUTOR_CUNNINGSTRIKE = register("cunningstrike", ElementalTypes.INSTANCE.getDARK());
  public static final Item TUTOR_FLASHFREEZE = register("flashfreeze", ElementalTypes.INSTANCE.getICE());
  public static final Item TUTOR_FRIGIDVAULT = register("frigidvault", ElementalTypes.INSTANCE.getICE());
  public static final Item TUTOR_HEAVYARTILLERY = register("heavyartillery", ElementalTypes.INSTANCE.getSTEEL());
  public static final Item TUTOR_HOARFROSTCRUSH = register("hoarfrostcrush", ElementalTypes.INSTANCE.getICE());
  public static final Item TUTOR_ICEBREAKER = register("icebreaker", ElementalTypes.INSTANCE.getICE());
  public static final Item TUTOR_JOLTRUSH = register("joltrush", ElementalTypes.INSTANCE.getELECTRIC());
  public static final Item TUTOR_NOSEDIVE = register("nosedive", ElementalTypes.INSTANCE.getFLYING());
  public static final Item TUTOR_PILEUP = register("pileup", ElementalTypes.INSTANCE.getELECTRIC());
