...
public class MoveTutorVillager {
    ...
    public static final PointOfInterestType POI_TYPE = PointOfInterestHelper.register(Identifier.of(TMCraft.MOD_ID, POI_ID), 1, 1, ModBlock.MOVE_TUTOR_TABLE_BLOCK.getBlock());
